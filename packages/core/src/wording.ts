...
export const EN = {
  ...
  'filing.door.writes': 'writes a governed file',
  'filing.door.take': 'Take it',
  'filing.door.blank': 'what goes where the engine left a blank',
  'filing.door.took': 'Taken. Read the line again to see what it did.',
