...
export const PT_BR: Wording = {
  ...
  'project.validation.verdict.worked': 'Funcionou',
  'project.validation.verdict.failed': 'Não funcionou',
  'project.validation.verdict.nothing-to-see': 'Não há o que ver',
  'project.validation.saw': 'O que você fez, e o que você viu',
  'project.validation.saw.placeholder': 'Uma frase, com suas palavras.',
  'project.validation.send': 'Registrar o veredito',
  'project.validation.sending': 'Registrando.',
  'project.validation.sent': 'Registrado em {id}: {verdict}.',
  ...
  'session.kind.created': 'criado',
  'session.kind.changed': 'alterado',
  'session.kind.deleted': 'apagado',
  'session.kind.undone': 'criado e depois sumiu',
  ...
  'session.file.tab.compare': 'Contra o original',
  'session.file.tab.file': 'O arquivo',
  'session.file.tab.edits': 'As chamadas',
  'session.file.compare.same': 'Nada difere do que era antes da sessão.',
  'session.file.compare.refused':
    'O arquivo é mais longo que as {ceiling} linhas que esta janela compara, então ele não é comparado.',
  'session.file.compare.none':
    'Nenhuma chamada desta sessão nomeou este arquivo, então não se sabe como ele era antes.',
  'session.file.compare.added': '{count} linhas adicionadas',
  'session.file.compare.added.one': '{count} linha adicionada',
  'session.file.compare.removed': '{count} linhas removidas',
  'session.file.compare.removed.one': '{count} linha removida',
  'session.file.compare.folded': '{count} linhas sem mudança',
  'session.file.compare.folded.one': '{count} linha sem mudança',
  'session.file.compare.side': 'Lado a lado',
  'session.file.compare.inline': 'Em linha',
