...
export const PT_BR: Wording = {
  ...
  'filing.door.writes': 'escreve um arquivo governado',
  'filing.door.take': 'Aceitar',
  'filing.door.blank': 'o que vai onde o engine deixou em branco',
  'filing.door.took': 'Aceito. Leia a linha de novo para ver o que mudou.',
